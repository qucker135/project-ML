...
from sklearn.metrics import matthews_corrcoef, roc_curve, auc, accuracy_score, precision_score, f1_score, recall_score
import datetime
import pickle
...
def GridSearchCustom(df, num_splits, estimator, param_grid, scoring, target_column, verbose):
    ...
    with open(f'GS_nasa_scores.pkl', 'wb') as pickle_file:
        pickle.dump({
